...
> Inclua o que é compartilhado, omita o que não é. (*Include what’s shared, omit what’s not.*)
...
- Crie um pull request e o marque como *work in progress* (WIP) até ter finalizado o desenvolvimento;
...
***Importante destacar que todos os nomes de diretórios, arquivos, variáveis, classes, métodos, propriedades, IDs, etc. devem estar em inglês.***
