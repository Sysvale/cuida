...
export default defineConfig({
	...
	themeConfig: {
		...
		nav: [
			...
			{ text: 'Docs Storybook/Framer', link: 'https://cuida.framer.wiki/' },
			...
			'/components/': [
				{
					...
					items: [
						...
						{ text: 'StepperInput <span class="docs-badge" type="danger">Deprecated</span>', link: '/components/forms/stepper-input' },
