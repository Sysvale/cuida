			...
			'/components/': [
				{
					...
					items: [
						...
						{ text: 'DateInput <Badge class="docs-badge"type="warning">WIP</Badge>', link: '/components/forms/date-input' },
						{ text: 'DynamicInputList', link: '/components/forms/dynamic-input-list' },
						{ text: 'FileInput', link: '/components/forms/file-input' },
						{ text: 'FilterSelect <Badge class="docs-badge"type="warning">WIP</Badge>', link: '/components/forms/filter-select' },
						...
						{ text: 'Select <Badge class="docs-badge"type="warning">WIP</Badge>', link: '/components/forms/select' },
