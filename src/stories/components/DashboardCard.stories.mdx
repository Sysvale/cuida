...
### DashboardCards são componentes utilizados para construir cards com informações que requeiram uma descrição curta,
### e que possam ser classificadas em status.
---
<br />

## Recomendamos o uso de DashboardCards quando:
- For necessário mostrar informações de modo resumido em dashboards
- For necessário um cards clicável e que leve o usuário a uma nova tela.
