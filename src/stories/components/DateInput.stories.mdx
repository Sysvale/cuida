...
### DateInputs permitem que o usuário selecione uma data ou um intervalo de datas através de um campo de texto e um calendário interativo.
---
<br />
...
- O usuário pode indicar a data digitando no input.
...
- O input de texto é desabilitado no modo range.
