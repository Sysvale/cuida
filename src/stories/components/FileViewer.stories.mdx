...
## Observações:
A URL fornecida para o componente deve conter no final qual é a extensão do arquivo. Apenas arquivos com extensões _png_, _jpg_, _jpeg_ e _webp_ terão a pré-visualização gerada.
