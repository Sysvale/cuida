...
import * as InteractionBlockingOverlayStories from './InteractionBlockingOverlay.stories';

<Meta of={InteractionBlockingOverlayStories} />
...
<Canvas>
  <Story of={InteractionBlockingOverlayStories.InteractionBlockingOverlay} />
</Canvas>
