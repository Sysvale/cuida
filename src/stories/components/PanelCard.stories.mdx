...
### PanelCards são componentes utilizados para um estilo padrão de card com header com título, subtítulo e elemento opcional à direita e um slot padrão para conteúdo.
---
<br />

## Recomendamos o uso de PanelCards quando:
