...
- For necessário apresentar um conjunto de ações em um menu divulgável.
...
## Observações:
- Mantenha o conteúdo do popover breve. Os usuários precisam fazer uma seleção ou inserir informações rapidamente para concluir a tarefa.
<br />
