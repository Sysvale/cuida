...
<Meta title="Utils/Composables/useToast"/>
...
- O useToast expõe os métodos `fire` e `dismiss`, além da lista global de toasts ativos na propriedade reativa `toastState`.
