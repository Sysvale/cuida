...
**(String):**
- Indica o posicionamento do componente em referência ao elemento alvo indicado pelo `target`
- Obrigatória: *Não*
...
**(String):**
- O id do elemento que o ContrastChecker vai usar como referência para se posicionar.
- Obrigatória: *Sim*
