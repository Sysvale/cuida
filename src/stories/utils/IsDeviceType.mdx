...
import * as IsDeviceTypeStories from './IsDeviceType.stories';

<Meta of={IsDeviceTypeStories} />
...
* Obrigatória: *Sim*
* Valores válidos: *smartphone*, *tablet*, *hd-screen*, *fhd-screen*, *uhd-screen*;
...
<Story of={IsDeviceTypeStories.IsDeviceType} />
...
<Canvas>
  <Story of={IsDeviceTypeStories.Button2} />
</Canvas>
