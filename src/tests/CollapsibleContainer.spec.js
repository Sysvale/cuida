...
describe("Click tests", () => {
  test("if container is expanded and an event is emitted when the item is clicked", async () => {
    ...
    expect(wrapper.find(".cds-collapsible-container__content").exists()).toBe(
      true
    );
    expect(
      wrapper.find(".cds-collapsible-container__icon--expanded").exists()
    ).toBe(true);
  ...
  test("if container is collapsed and an event is emitted when the item is clicked", async () => {
    ...
    expect(
      wrapper.find(".cds-collapsible-container__icon--collapsed").exists()
    ).toBe(true);
