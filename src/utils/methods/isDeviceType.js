export default (device) => {
	switch (device) {
		...
		case 'tablet':
			...
			return window.outerWidth >= 500 && window.outerWidth < 800 && window.outerWidth < window.outerHeight;
		case 'hd-screen':
			// se a largura da tela estiver entre 900px e 1500px, e maior que a altura da tela
			return window.outerWidth > 900 && window.outerWidth < 1500 && window.outerWidth > window.outerHeight ;
		case 'fhd-screen':
